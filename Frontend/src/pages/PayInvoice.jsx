...
export default function PayInvoice() {
  ...
  const [paypalClientId, setPaypalClientId] = useState(null);   // ← Dynamic Client ID
  ...
  // Create PayPal Order (Backend) - Gets dynamic clientId
  useEffect(() => {
    ...
    const createOrder = async () => {
      ...
      try {
        ...
        setPaypalClientId(data.clientId);        // ← Important: Dynamic Client ID
            ...
            <div>
              ...
              {orderLoading ? (
                <div className="text-center py-12">
                  ...
                  <p className="mt-4 text-gray-600">Creating secure payment order...</p>
                </div>
